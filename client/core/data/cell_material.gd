...
## Affect character ground friction when moving on this cell.
## >1 is more slippery, <1 is more sticky.
## Can be changed while in-game.
@export_range(0.0, 2.0, 0.01, "or_greater") var friction_multiplier := 1.0
